...
public:
    ASwitch(id_t id, std::string name, unsigned int level, unsigned int num_in_level, Config_stonne stonne_cfg);
    ASwitch(id_t id, std::string name, unsigned int level, unsigned int num_in_level, Config_stonne stonne_cfg, Connection* inputLeftConnection,
