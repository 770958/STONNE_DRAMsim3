...
public:
    Accumulator(id_t id, std::string name, Config_stonne stonne_cfg, unsigned int n_accumulator);
    Accumulator(id_t id, std::string name, Config_stonne stonne_cfg, unsigned int n_accumulator, Connection* inputConnection, Connection* outputConnection);
    ~Accumulator();
