...
private:
	...
	unsigned int ds_global_cycle;
    
public:
    DSNetwork(id_t id, std::string name, Config_stonne stonne_cfg, unsigned int ms_size, Connection* inputConnection); //ms_size = ms_size of the group that contain this tree
    ~DSNetwork();
