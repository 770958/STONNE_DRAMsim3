...
private:
	...
	unsigned long long ds_cycle;
	unsigned long long ds_num;

	MemoryController_t mc;
...
public:
    ...
    DSwitch(id_t id, std::string name, unsigned int level, unsigned int num_in_level, Config_stonne stonne_cfg, unsigned int ms_size); //Output bandwidth is the bw per branch
    DSwitch(id_t id, std::string name, unsigned int level, unsigned int num_in_level, Config_stonne stonne_cfg, unsigned int ms_size, Connection* leftConnection, Connection* rightConnection, Connection* inputConnection);
