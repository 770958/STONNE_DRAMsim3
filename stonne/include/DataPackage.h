...
private:
	...
	unsigned long long delay; //cycles delay
	...
	std::string added_cycle_to_dram;
	std::string addr_to_dram;
	std::string req_type;
	std::string addr_type;
	std::string req_source;
...
public:
	...
	void setDelay(unsigned long long delay); //set delay
	unsigned long long getDelay();

	void setAdded_cycle(std::string s) { this->added_cycle_to_dram = s; }
	std::string getAdded_cycle() { return this->added_cycle_to_dram; }

	void setReq_type(std::string s) { this->req_type = s; }
	std::string getReq_type() { return this->req_type; }

	void setAddr_to_dram(std::string s) { this->addr_to_dram = s; }
	std::string getAddr_to_dram() { return this->addr_to_dram; }

	void setAddr_type(std::string s) { this->addr_type = s; }
	std::string getAddr_type() { return this->addr_type; }

	void setReq_source(std::string s) { this->req_source = s; }
	std::string getReq_source() { return this->req_source; }
