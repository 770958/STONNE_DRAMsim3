...
public:
    MSwitch(id_t id, std::string name, int num, Config_stonne stonne_cfg);
    MSwitch(id_t id, std::string name, int num, Config_stonne stonne_cfg, Connection* outputConnection, Connection* inputConnection);
    ~MSwitch();
