...
private:
	...
	unsigned long long ms_num;

public:
    MultiplierOS(id_t id, std::string name, int row_num, int col_num, Config_stonne stonne_cfg);
    MultiplierOS(id_t id, std::string name, int row_num, int col_num, Config_stonne stonne_cfg, Connection* left_connection, Connection* right_connection, Connection* top_connection, Connection* bottom_connection);
    ~MultiplierOS();
