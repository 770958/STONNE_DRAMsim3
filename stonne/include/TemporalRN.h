...
private:
	...
	unsigned long long as_num;
	unsigned int as_cycle;
	unsigned int as_global_cycle;
    
public:
    TemporalRN(id_t id, std::string name, Config_stonne stonne_cfg, Connection* output_connection);
    ~TemporalRN();
