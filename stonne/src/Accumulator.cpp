...
Accumulator::Accumulator(id_t id, std::string name, Config_stonne stonne_cfg, unsigned int n_accumulator)  : Unit(id, name) {
...
void Accumulator::printConfiguration(std::ofstream & out, unsigned int indent)
{
}
...
unsigned int Accumulator::get_cycle()
{
	return this->local_cycle;
}

unsigned int Accumulator::get_global_cycle()
{
	return this->aswitchStats.total_cycles;
}

unsigned int Accumulator::get_Instruction()
{
	return this->as_num;
}
