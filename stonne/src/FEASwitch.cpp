...
FEASwitch::FEASwitch(id_t id, std::string name, unsigned int level, unsigned int num_in_level, Config_stonne stonne_cfg) : Unit(id, name) {
    this->level = level;
...
FEASwitch::FEASwitch(id_t id, std::string name, unsigned int level, unsigned int num_in_level, Config_stonne stonne_cfg, Connection* inputLeftConnection,
...
unsigned long long FEASwitch::get_Instruction()
{
	return this->as_num;
}

unsigned int FEASwitch::get_cycle()
{
	return this->local_cycle;
}

unsigned int FEASwitch::get_global_cycle()
{
