...
OSMeshMN::OSMeshMN(id_t id, std::string name, Config_stonne stonne_cfg) : MultiplierNetwork(id, name) {
...
unsigned long long OSMeshMN::get_Instruction()
{
	return ms_num;
}

unsigned int OSMeshMN::get_cycle()
{
	return this->ms_cycle;
}

unsigned int OSMeshMN::get_global_cycle()
{
