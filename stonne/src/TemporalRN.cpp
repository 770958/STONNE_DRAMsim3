...
TemporalRN::TemporalRN(id_t id, std::string name, Config_stonne stonne_cfg, Connection* outputConnection) : ReduceNetwork(id, name) {
...
void TemporalRN::cycle() {
	...
	//std::cout << "asnum: " << this->as_num << std::endl;
	//this->as_global_cycle = this->accumulationBuffer->get_global_cycle();
}
...
unsigned long long TemporalRN::get_Instruction()
{
	return this->as_num;
}

unsigned int TemporalRN::get_cycle()
{
	return this->as_cycle;
}

unsigned int TemporalRN::get_global_cycle()
{
