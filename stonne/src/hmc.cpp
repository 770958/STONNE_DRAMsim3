...
bool HMCMemorySystem::AddTransaction(uint64_t hex_addr, bool is_write, std::string addr_str) {
...
std::queue<int> HMCMemorySystem::ReturnDelay()
{
	return std::queue<int>();
}

void HMCMemorySystem::FreeDelayQueue() {
