...
unsigned int T_X_, unsigned int T_Y_, Config_stonne stonne_cfg, unsigned int n_test) {
    float EPSILON=0.001;
    ...
    stonne_instance->run("TestLayer"); //Running the simulator 
...
void run_real_tests() {
	 ...
	 Config_stonne stonne_cfg; //Creating stonne configuration object
